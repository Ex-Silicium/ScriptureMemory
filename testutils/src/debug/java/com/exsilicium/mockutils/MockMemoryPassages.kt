...
object MockMemoryPassages {
    ...
    val MOCK_PASSAGE_JOHN_3_16 = MemoryPassage(0, MOCK_REFERENCE_JOHN_3_16, "For God so loved the world...")

    private val MOCK_PASSAGE_ROMANS_3_23 =
            MemoryPassage(1, ScriptureReference(Book.ROMANS, Verse(3, 23)), "For all have sinned...")
